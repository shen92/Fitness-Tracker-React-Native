...
import {View, Text, StyleSheet, SafeAreaView, ScrollView, AsyncStorage, RefreshControl} from "react-native";
...
class ProfileTab extends Component {
    ...
    initUserData(result) {
        ...
        result.lastName === null ?
            this.setState({lastName: ''}) : this.setState({lastName: result.lastName});
