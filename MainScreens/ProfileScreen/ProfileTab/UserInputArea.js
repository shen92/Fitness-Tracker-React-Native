    ...
    render() {
        return (
            <React.Fragment>
                ...
                {this.getInput("Goal Daily Calories (cal)", this.props.data.goalDailyCalories)}
                {this.getInput("Goal Daily Activity (cal)", this.props.data.goalDailyActivity)}
                {this.getInput("Goal Daily Protein (g)", this.props.data.goalDailyProtein)}
                {this.getInput("Goal Daily Carbohydrates (g)", this.props.data.goalDailyCarbohydrates)}
