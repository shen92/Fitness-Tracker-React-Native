...
import {AsyncStorage, SafeAreaView, ScrollView, StyleSheet, Text, View, RefreshControl,} from "react-native";
...
class DailySummaryTab extends Component {
    ...
    setUserProfileData(result) {
        result.firstName === null ?
            this.setState({firstName: ''}) : this.setState({firstName: result.firstName});
    ...
    getGreetings() {
        ...
        } else if (this.state.date.getHours() >= 13 && this.state.date.getHours() < 18) {
            if (this.state.firstName !== '') {
                return (
                    <React.Fragment>
        ...
        } else if (this.state.date.getHours() >= 18 || this.state.date.getHours() < 6) {
            if (this.state.firstName !== '') {
                return (
                    <React.Fragment>
